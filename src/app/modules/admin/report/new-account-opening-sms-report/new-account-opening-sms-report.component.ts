...
@Component({
  ...
  templateUrl: './new-account-opening-sms-report.component.html',
  styleUrls: ['./new-account-opening-sms-report.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations   : fuseAnimations
})
export class NewAccountOpeningSmsReportComponent implements OnInit {
  ...
  fetchAllTransaction(){
      ...
      this.isLoading = true;
      this.utilityApi.getNewAccountOpeningSmsReports(queryData).subscribe((response: any) => {
