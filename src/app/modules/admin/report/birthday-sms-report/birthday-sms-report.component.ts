...
@Component({
  ...
  templateUrl: './birthday-sms-report.component.html',
  styleUrls: ['./birthday-sms-report.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations   : fuseAnimations
})
export class BirthdaySmsReportComponent implements OnInit {
  ...
  fetchAllTransaction(){
      ...
      this.utilityApi.getBirthdaySmsReports(queryData).subscribe((response: any) => {
