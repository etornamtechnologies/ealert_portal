...
@Component({
  ...
  templateUrl: './new-account-opening-email-report.component.html',
  styleUrls: ['./new-account-opening-email-report.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations   : fuseAnimations
})
export class NewAccountOpeningEmailReportComponent implements OnInit {
  ...
  fetchAllTransaction(){
      ...
      this.isLoading = true;
      this.utilityApi.getNewAccountOpeningEmailReports(queryData).subscribe((response: any) => {
