...
@Component({
  selector: 'app-account-exemption',
  templateUrl: './account-exemption.component.html',
  styleUrls: ['./account-exemption.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations   : fuseAnimations
})
export class AccountExemptionComponent implements OnInit {

  reportFilter: FormGroup;
  displayedColumns: string[] = ['account_name','account_no','created_by','created_date','actions'];
